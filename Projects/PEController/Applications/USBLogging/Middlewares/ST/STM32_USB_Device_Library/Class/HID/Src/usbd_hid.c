...
#define HID_BUFFER_SIZE_LOW_IN               			(0x00)
#define HID_BUFFER_SIZE_HIGH_IN							(0x4)
#define HID_BUFFER_SIZE_LOW_OUT                   		(200)
#define HID_BUFFER_SIZE_HIGH_OUT						(0x00)
...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgHSDesc[USB_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  HID_EPIN_ADDR|(1 << 7),
  0x03,
  HID_BUFFER_SIZE_LOW_IN, HID_BUFFER_SIZE_HIGH_IN,
  HID_HS_BINTERVAL,
  ...
  2|(0 << 7),
  0x03,
  HID_BUFFER_SIZE_LOW_OUT, HID_BUFFER_SIZE_HIGH_OUT,
  HID_HS_BINTERVAL
};
...
__ALIGN_BEGIN static uint8_t HID_MOUSE_ReportDesc[HID_MOUSE_REPORT_DESC_SIZE] __ALIGN_END =
{
	...
	0x96, HID_BUFFER_SIZE_LOW_IN,HID_BUFFER_SIZE_HIGH_IN, 		//		Report Count (0x40)
	...
	0x26, 0xFF, 0x00, 											//		Logical Maximum (255)
	0x75, 0x08, 												//		Report Size (8 bits)
	0x96, HID_BUFFER_SIZE_LOW_OUT,HID_BUFFER_SIZE_HIGH_OUT,		//		Report Count (0x40)
	0x91, 0x02, 												//		Output (Data, Variable, Absolute)
	0x09, 0x04, 												//		Usage (vendor-defined)
	0x15, 0x00, 												//		Logical Minimum (0)
	0x26, 0xFF, 0x00, 											//		Logical Maximum (255)
	0x75, 0x08, 												//		Report Size (8 bits)
	0x95, 0x39, 												//		Report Count (2)
