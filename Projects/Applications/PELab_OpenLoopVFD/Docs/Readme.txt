...
CM4:
1. Displaus the LOGO on screen using the LTDC module.
...
3. The ADC data variable "sharedData->lastDataPointer" contains the most recent data for all the ADC channels respectively. The scaling factors for these channels are configured according to the PELab 6 Phase configuration in the file MAX11046App.c
